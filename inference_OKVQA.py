...
model = Magma.from_checkpoint(config_path = "configs/MAGMA_gpt_med.yml",checkpoint_path = "/local1/monajati/magma/checkpoints/meta/global_step4100/mp_rank_00_model_states.pt", device = 'cuda:0')

model=model.float()
#"../../check/global_step19945/mp_rank_00_model_states.pt"

val_df=pd.read_csv('val_ok.csv')
...
for i in range(100):
    ...
    ans_inputs = tokenizer(answer, return_tensors="pt")
    #print(ans_inputs['input_ids'].shape[1])
