...
model = Magma.from_checkpoint(config_path = "configs/MAGMA_adap_med.yml",checkpoint_path = "/local1/monajati/magma/checkpoints/adap_meta_1/global_step3500/mp_rank_00_model_states.pt", device = 'cuda:0')
