...
class Magma(nn.Module):
    def __init__(self, config, device=None):
        ...
        #print(begh)
        #self.lm = get_gptj().to_device()
        self.lm = get_gptj().to(self.device)
        #print("self.lm.config",self.lm.config)
        ...
        #print("input resolution",self.image_prefix.enc.input_resolution)
        #print(begh)
        ...
        #for name, param in self.lm.named_parameters():
            #print("name, param",name, param.requires_grad)
    ...
    def forward(
        ...
        print("word_embeddings2.shape",word_embeddings[:, : -input_embeddings.shape[1], :].shape)
        ...
        #print("input_embeddings2.shape",input_embeddings.shape)
