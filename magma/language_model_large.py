...
def get_gptj(
    ...
    if from_pretrained:
        ...
        torch.save(model.state_dict(),"/home/monajati/main/metaVL/magma/gpt/gpt2-large.pt")
        ...
        state_dict = torch.load("/home/monajati/main/metaVL/magma/gpt/gpt2-large.pt", map_location="cpu")
