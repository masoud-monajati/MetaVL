...
def get_gptj(
    ...
    if from_pretrained:
        ...
        with no_init_weights():
            ...
            torch.save(model.state_dict(),"/home/monajati/main/metaVL/magma/gpt/model.pt")
            ...
            state_dict = torch.load("/home/monajati/main/metaVL/magma/gpt/model.pt", map_location="cpu")
